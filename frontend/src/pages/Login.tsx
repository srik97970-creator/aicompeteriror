  ...
  return (
    <div className="min-h-screen bg-slate-950 flex flex-col justify-center py-12 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="absolute top-5 right-5 z-20">
        <button
          onClick={toggleTheme}
          className="p-2.5 bg-slate-900/60 border border-slate-800/80 backdrop-blur-md rounded-xl text-slate-400 hover:text-white hover:bg-slate-800 transition-colors shadow-lg cursor-pointer"
            ...
            <div>
              ...
              <div className="relative rounded-xl shadow-sm">
                ...
                <input
                  ...
                  className="block w-full pl-10 pr-3 py-3 bg-slate-950/60 border border-slate-800 focus:border-indigo-500 rounded-xl focus:outline-none focus:ring-1 focus:ring-indigo-500 text-sm text-slate-100 placeholder-slate-500 transition-colors"
                  placeholder="name@nethigupta.com"
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative rounded-xl shadow-sm">
                ...
                <input
                  ...
                  className="block w-full pl-10 pr-10 py-3 bg-slate-950/60 border border-slate-800 focus:border-indigo-500 rounded-xl focus:outline-none focus:ring-1 focus:ring-indigo-500 text-sm text-slate-100 placeholder-slate-500 transition-colors"
                  placeholder="••••••••"
                />
                <button
                  type="button"
            ...
            <div className="flex items-center justify-between text-xs">
              <div className="flex items-center">
                <input
                  ...
                  className="h-4 w-4 bg-slate-950 border-slate-800 text-indigo-600 focus:ring-indigo-500 focus:ring-offset-slate-900 rounded cursor-pointer"
                />
              ...
              <div className="text-sm">
                <button
                  type="button"
                  onClick={() => toastError('Please contact the Nethi Mallikarjun Gupta IT administrator to reset your password.')}
                  className="font-semibold text-indigo-400 hover:text-indigo-305 transition-colors"
                >
                  Forgot password?
                </button>
              </div>
