            ...
            <div>
              ...
              <div className="relative rounded-xl shadow-sm">
                ...
                <input
                  ...
                  className="block w-full pl-10 pr-3 py-2.5 bg-slate-950/60 border border-slate-800 focus:border-indigo-500 rounded-xl focus:outline-none focus:ring-1 focus:ring-indigo-500 text-sm text-slate-100 placeholder-slate-500 transition-colors"
            ...
            <div>
              ...
              <div className="relative rounded-xl shadow-sm">
                ...
                <input
                  ...
                  className="block w-full pl-10 pr-3 py-2.5 bg-slate-950/60 border border-slate-800 focus:border-indigo-500 rounded-xl focus:outline-none focus:ring-1 focus:ring-indigo-500 text-sm text-slate-100 placeholder-slate-500 transition-colors"
                  placeholder="john@nethigupta.com"
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative rounded-xl shadow-sm">
                ...
                <input
                  ...
                  className="block w-full pl-10 pr-10 py-2.5 bg-slate-950/60 border border-slate-800 focus:border-indigo-500 rounded-xl focus:outline-none focus:ring-1 focus:ring-indigo-500 text-sm text-slate-100 placeholder-slate-500 transition-colors"
                  placeholder="••••••••"
                />
                <button
                  type="button"
